...
$(document).ready(function() {
	...
	switch (Turno) {
		...
		case "Speed":
			$("#Placeholder_009").text("Low Speed");
			switch (Select) {
				case "1":
					$("#MSG_I01, #Placeholder_009, #MSG_Box_009").fadeIn("slow", function() {

					});
					break;
				case "2":
					$("#MSG_I02, #Placeholder_009, #MSG_Box_009").fadeIn("slow", function() {

					});
					break;
				case "3":
					$("#MSG_I03, #Placeholder_009, #MSG_Box_009").fadeIn("slow", function() {
		...
		case "Block":
			$("#Placeholder_010").text("Blocked User");
			switch (Select) {
				case "1":
					$("#MSG_J01, #Placeholder_010, #MSG_Box_010").fadeIn("slow", function() {

					});
					break;
				case "2":
					$("#MSG_J02, #Placeholder_010, #MSG_Box_010").fadeIn("slow", function() {

					});
					break;
				case "3":
					$("#MSG_J03, #Placeholder_010, #MSG_Box_010").fadeIn("slow", function() {
		...
		case "Support":
			$("#Placeholder_011").text("Support Opening");
			switch (Select) {
				case "1":
					$("#MSG_K01, #Placeholder_011, #MSG_Box_011").fadeIn("slow", function() {

					});
					break;
				case "2":
					$("#MSG_K02, #Placeholder_011, #MSG_Box_011").fadeIn("slow", function() {

					});
					break;
				case "3":
					$("#MSG_K03, #Placeholder_011, #MSG_Box_011").fadeIn("slow", function() {
...
$(document).ready(function() {
	...
	$("#OnSpeed").on('change', function() {
		if ($(this).is(":checked")) {
			Enable = true;
		} else {
			Enable = false;
		}
		Scheduler("#OnSpeed", Enable);
	});


	$("#OnBlock").on('change', function() {
		if ($(this).is(":checked")) {
			Enable = true;
		} else {
			Enable = false;
		}
		Scheduler("#OnBlock", Enable);
	});


	$("#OnSupport").on('change', function() {
		if ($(this).is(":checked")) {
			Enable = true;
		} else {
			Enable = false;
		}
		Scheduler("#OnSupport", Enable);
	});
	...
	socket.on('A009', function(data) {
		$('.Speed_001').val(data);
	});
	socket.on('A010', function(data) {
		$('.Block_001').val(data);
	});
	socket.on('A011', function(data) {
		$('.Support_001').val(data);
	});
	...
	socket.on('B009', function(data) {
		$('.Speed_002').val(data);
	});
	socket.on('B010', function(data) {
		$('.Block_002').val(data);
	});
	socket.on('B011', function(data) {
		$('.Support_002').val(data);
	});
	...
	socket.on('C009', function(data) {
		$('.Speed_003').val(data);
	});
	socket.on('C010', function(data) {
		$('.Block_003').val(data);
	});
	socket.on('C011', function(data) {
		$('.Support_003').val(data);
	});
	...
	socket.on('onbot', function(data) {
		switch (data) {
			case 'true':
				$("#onbot").prop("checked", true);
				$("#response, #replyes").prop('disabled', false);
				break;
			case 'false':
				$("#onbot").prop("checked", false);
	...
	socket.on('OnSpeed', function(data) {
		switch (data) {
			case 'true':
				$("#OnSpeed").prop("checked", true);
				break;
			case 'false':
				$("#OnSpeed").prop("checked", false);
				break;
		}
	});


	socket.on('OnBlock', function(data) {
		switch (data) {
			case 'true':
				$("#OnBlock").prop("checked", true);
				break;
			case 'false':
				$("#OnBlock").prop("checked", false);
				break;
		}
	});


	socket.on('OnSupport', function(data) {
		switch (data) {
			case 'true':
				$("#OnSupport").prop("checked", true);
				break;
			case 'false':
				$("#OnSupport").prop("checked", false);
				break;
		}
	});
	...
	socket.on('replyes', function(data) {
		switch (data) {
			case 'true':
				$("#replyes").prop("checked", true);
				break;
			case 'false':
				$("#replyes").prop("checked", false);
				break;
		}
	});
	...
	socket.on('developer', function(src) {
		$('#developer').attr('src', src);
		$('#developer').show();
	});
...
$(document).ready(function() {
	...
	$('#ButtonCode').on({
		"click": function() {
			$(this).Pix("#PixCode");
			$(".PixCode").removeClass("fa-clone").addClass("fa-check").prop('disabled', true);
			$(".PixCode").fadeIn("fast", function() {
				$(this).tooltip({
					effect: "blind",
					duration: 1000,
					content: 'Copyed!',
					...
					close: function(event, ui) {
						$(".PixCode").fadeOut("fast", function() {
							$(".PixCode").removeClass("fa-check").addClass("fa-clone").prop('disabled', false);
							$(".PixCode").fadeIn("fast", function() {
	...
	$('#ButtonKey').on({
		"click": function() {
			$(this).Pix("#PixKey");
			$(".PixKey").removeClass("fa-clone").addClass("fa-check").prop('disabled', true);
			$(".PixKey").fadeIn("fast", function() {
				$(this).tooltip({
					effect: "blind",
					duration: 1000,
					content: 'Copyed!',
					...
					close: function(event, ui) {
						...
						$(".PixKey").fadeOut("fast", function() {
							$(".PixKey").removeClass("fa-check").addClass("fa-clone").prop('disabled', false);
							$(".PixKey").fadeIn("fast", function() {
								$(this).tooltip('disable');
							});
						});
			...
			if ($("#interval").val().length < 1 || $("#interval").val() == "") {
				...
				if ($("#sendwait").val().length < 2 || $("#sendwait").val() == "") {
					...
					if ($("#access").val().length < 4 || $("#access").val() == "") {
						...
						if ($("#count").val().length < 1 || $("#count").val() == "") {
							$("#count").val("").focus();
						} else {
