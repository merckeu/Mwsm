...
```sh
cd ~ && cd /var/api/Mwsm && pm2 stop Bot-Mwsm && pm2 flush && git reset --hard HEAD~1 && git pull "https://github.com/MKCodec/Mwsm.git" --rebase --autostash && npm install --silent && npm run start:mwsm && pm2 restart Bot-Mwsm
